...
import Data.Lens (Prism', Traversal, Traversal', _1, _Left, _Right, _Just, is, isn't, nearly, only, preview, prism, prism', review, traversed)
...
-- think of a paint program filling a shape
data Fill
  = Solid Color
...
_right_solidFill ∷ ∀ ignore. Prism' (Either ignore Fill) Color
_right_solidFill = _Right <<< _solidFill

_traversed_solidFill ∷ ∀ trav. Traversable trav ⇒ Traversal' (trav Fill) Color
_traversed_solidFill = traversed <<< _solidFill

_right_traversed ∷ ∀ trav a b _1_. Traversable trav ⇒ Traversal (Either _1_ (trav a)) (Either _1_ (trav b)) a b
_right_traversed = _Right <<< traversed

_1_solidFill ∷ ∀ _1_. Traversal' (Tuple Fill _1_) Color
_1_solidFill = _1 <<< _solidFill

_left_1 ∷ ∀ a b _1_ _2_. Traversal (Either (Tuple a _1_) _2_) (Either (Tuple b _1_) _2_) a b
_left_1 = _Left <<< _1

_left_ix1 ∷ ∀ _1_ indexed a. Index indexed Int a ⇒ Traversal' (Either indexed _1_) a
_left_ix1 = _Left <<< ix 1

_ix1_left ∷ ∀ _1_ indexed a. Index indexed Int (Either a _1_) ⇒ Traversal' indexed a
_ix1_left = ix 1 <<< _Left

_at1_just ∷ ∀ keyed a. At keyed Int a ⇒ Traversal' keyed a
