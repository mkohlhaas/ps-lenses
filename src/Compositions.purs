...
_1_1 ∷ ∀ a _1_ _2_. Lens' (Tuple (Tuple a _1_) _2_) a
_1_1 = _1 <<< _1

_1_at ∷ ∀ keyed _2_ a. At keyed Int a ⇒ Lens' (Tuple keyed _2_) (Maybe a)
_1_at = _1 <<< at 1

_at_trav ∷ ∀ keyed a. At keyed Int a ⇒ Traversal' keyed a
_at_trav = at 1 <<< traversed

_at_Just ∷ ∀ keyed a. At keyed Int a ⇒ Traversal' keyed a
