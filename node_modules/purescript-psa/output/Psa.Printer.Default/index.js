...
var Psa_Printer = require("../Psa.Printer/index.js");
        ...
        return function (col3) {
            return function (col4) {
                var lineLength = (function () {
                    var $42 = Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt);
                    var $43 = Data_Functor.map(Data_Functor.functorArray)(Psa_Printer.ansiLength);
                    return function ($44) {
                        return $42($43($44));
                    };
                })();
...
var renderVerboseStats = function (stats) {
    var warnings = Data_Array.sort(Data_Ord.ordString)(Foreign_Object.keys(stats.allWarnings));
    var warningLabels = Data_Functor.map(Data_Functor.functorArray)((function () {
        var $45 = Psa_Printer.style(Ansi_Output.foreground(Ansi_Codes.Yellow.value));
        return function ($46) {
            return Data_Array.singleton($45($46));
        };
    })())(warnings);
    ...
    var errors = Data_Array.sort(Data_Ord.ordString)(Foreign_Object.keys(stats.allErrors));
    var libErrors = getStats(errors)(stats.libErrors);
    var srcErrors = getStats(errors)(stats.srcErrors);
    var errorLabels = Data_Functor.map(Data_Functor.functorArray)((function () {
        var $47 = Psa_Printer.style(Ansi_Output.foreground(Ansi_Codes.Red.value));
        return function ($48) {
            return Data_Array.singleton($47($48));
        };
    })())(errors);
...
var print = function (options) {
    return function (output) {
        ...
        var renderStats$prime = (function () {
            if (options.statVerbosity instanceof Psa_Types.NoStats) {
                return Data_Monoid.mempty(Data_Monoid.monoidFn(Psa_Printer.monoidRow));
            };
            if (options.statVerbosity instanceof Psa_Types.CompactStats) {
                return renderStats;
            };
            if (options.statVerbosity instanceof Psa_Types.VerboseStats) {
                return renderVerboseStats;
            };
            throw new Error("Failed pattern match at Psa.Printer.Default (line 44, column 18 - line 47, column 39): " + [ options.statVerbosity.constructor.name ]);
        })();
        var lenWarnings = Data_Array.length(output.warnings);
        var lenErrors = Data_Array.length(output.errors);
        return function __do() {
            Psa_Util.iter_(Data_Foldable.foldableArray)(Effect.applicativeEffect)(output.warnings)(function (i) {
                return function (warning) {
                    return function __do() {
                        Effect_Console.error(toString(renderWarning(lenWarnings)(i + 1 | 0)(warning)))();
                        return Effect_Console.error("")();
                    };
                };
            })();
            Psa_Util.iter_(Data_Foldable.foldableArray)(Effect.applicativeEffect)(output.errors)(function (i) {
                return function (error) {
                    return function __do() {
                        Effect_Console.error(toString(renderError(lenErrors)(i + 1 | 0)(error)))();
                        return Effect_Console.error("")();
                    };
                };
            })();
            return Effect_Console.error(toString(renderStats$prime(output.stats)))();
        };
    };
};
module.exports = {
