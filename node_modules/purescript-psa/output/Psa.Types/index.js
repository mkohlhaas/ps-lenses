...
var encodeSuggestion = function (suggestion) {
    return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeForeignObject(Data_Argonaut_Encode_Class.encodeJsonJson))(Foreign_Object.runST(function __do() {
        var obj = Foreign_Object_ST["new"]();
        Foreign_Object_ST.poke("replacement")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(suggestion.replacement))(obj)();
        Foreign_Object_ST.poke("replaceRange")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Maybe.maybe(Data_Argonaut_Core.jsonNull)(encodePosition)(suggestion.replaceRange)))(obj)();
        return obj;
    }));
};
var encodePsaError = function (error) {
    return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeForeignObject(Data_Argonaut_Encode_Class.encodeJsonJson))(Foreign_Object.runST(function __do() {
        var obj = Foreign_Object_ST["new"]();
        Foreign_Object_ST.poke("moduleName")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Argonaut_Encode_Class.encodeJsonJString))(error.moduleName))(obj)();
        Foreign_Object_ST.poke("errorCode")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(error.errorCode))(obj)();
        Foreign_Object_ST.poke("errorLink")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(error.errorLink))(obj)();
        Foreign_Object_ST.poke("message")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(error.message))(obj)();
        Foreign_Object_ST.poke("filename")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Argonaut_Encode_Class.encodeJsonJString))(error.filename))(obj)();
        Foreign_Object_ST.poke("position")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Maybe.maybe(Data_Argonaut_Core.jsonNull)(encodePosition)(error.position)))(obj)();
        Foreign_Object_ST.poke("suggestion")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Maybe.maybe(Data_Argonaut_Core.jsonNull)(encodeSuggestion)(error.suggestion)))(obj)();
        return obj;
    }));
};
var encodePsaResult = function (res) {
    return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeForeignObject(Data_Argonaut_Encode_Class.encodeJsonJson))(Foreign_Object.runST(function __do() {
        var obj = Foreign_Object_ST["new"]();
        Foreign_Object_ST.poke("warnings")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJson))(Data_Functor.map(Data_Functor.functorArray)(encodePsaError)(res.warnings)))(obj)();
        Foreign_Object_ST.poke("errors")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJson))(Data_Functor.map(Data_Functor.functorArray)(encodePsaError)(res.errors)))(obj)();
        return obj;
    }));
};
