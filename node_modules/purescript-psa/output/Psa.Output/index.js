...
var trimMessage = (function () {
    ...
    var $112 = Data_String_Common.joinWith("\x0a");
    var $113 = Data_Foldable.foldl(Data_Foldable.foldableArray)(collapse)([  ]);
    var $114 = Data_Foldable.foldl(Data_Foldable.foldableArray)(dedent)({
        lines: [  ],
        indent: Data_Bounded.top(Data_Bounded.boundedInt)
    });
    var $115 = Data_String_Common.split("\x0a");
    return function ($116) {
        return Data_String_Common.trim($112($113((function (v) {
            return v.lines;
        })($114($115($116))))));
    };
})();
...
var errorPath = function (libDirs) {
    return function (path) {
        return function ($$short) {
            ...
            var $102 = Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (dir) {
    ...
    return function (loadLines) {
        return function (options) {
            return function (result) {
                        ...
                        return function (v) {
                            var update = function (log) {
                                ...
                                var tag$prime = (function () {
                                    var $108 = printed && (options.strict && isSrc(v.value0));
                                    if ($108) {
                                        return $$Error.value;
                                    };
                                    return tag;
                            ...
                            var $109 = shouldShowError(options)(tag)(v.value0)(v.value1.errorCode);
                            if ($109) {
                                return Control_Bind.bind(dictMonad.Bind1())(Data_Maybe.fromMaybe(Control_Applicative.pure(dictMonad.Applicative0())(Data_Maybe.Nothing.value))(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(loadLines)(v.value1.filename))(v.value1.position)))(function (source) {
                ...
                return Control_Bind.bind(dictMonad.Bind1())(Data_Array.foldM(dictMonad)(onError(Warning.value))(initialState)(result$prime.warnings))(function (state) {
                    return Control_Bind.bind(dictMonad.Bind1())(Data_Array.foldM(dictMonad)(onError($$Error.value))(state)(result$prime.errors))(function (state$prime) {
                        return Control_Applicative.pure(dictMonad.Applicative0())({
                            warnings: Data_Array.sortBy(Psa_Types.compareByLocation)(state$prime.warnings),
                            errors: Data_Array.sortBy(Psa_Types.compareByLocation)(state$prime.errors),
