          ...
          appendRecord: function(v) {
            return function(ra) {
              return function(rb) {
                ...
                var insert8 = unsafeSet(key);
                var get3 = unsafeGet(key);
                return insert8(append17(get3(ra))(get3(rb)))(tail4);
              };
            };
          }
        };
...
var sortByImpl = function() {
  function mergeFromTo(compare9, fromOrdering, xs1, xs2, from2, to) {
    var mid;
    var i;
    var j;
    var k;
    ...
    if (mid - from2 > 1)
      mergeFromTo(compare9, fromOrdering, xs2, xs1, from2, mid);
    if (to - mid > 1)
      mergeFromTo(compare9, fromOrdering, xs2, xs1, mid, to);
    i = from2;
    j = mid;
    k = from2;
    while (i < mid && j < to) {
...
var monoidRecordCons = function(dictIsSymbol) {
  ...
  return function(dictMonoid) {
    var mempty14 = mempty(dictMonoid);
      ...
      while (map4(not2)(read2($$break3))()) {
        (function __do2() {
          ...
          if (mx instanceof Nothing) {
            return $$void2(write2(true)($$break3))();
          }
          ;
            ...
            function go(bot, top6) {
              switch (top6 - bot) {
                ...
                default:
                  ...
                  return apply6(map18(concat22)(go(bot, pivot)))(go(pivot, top6));
              }
            }
...
var foldableNonEmpty = function(dictFoldable) {
  ...
  return {
    foldMap: function(dictMonoid) {
      ...
      return function(f) {
        return function(v) {
          return append17(f(v.value0))(foldMap13(f)(v.value1));
        };
      };
    },
    foldl: function(f) {
...
var sortWith2 = function(dictOrd) {
  var sortWith12 = sortWith(dictOrd);
  return function(f) {
    return unsafeAdapt(sortWith12(f));
  };
};
...
var applyList = {
  apply: function(v) {
    return function(v1) {
      ...
      ;
      if (v instanceof Cons) {
        return append1(map5(v.value0)(v1))(apply2(applyList)(v.value1)(v1));
      }
      ;
      ...
      return function($copy_m) {
        ...
        function $tco_loop(ctx, m) {
          ...
          if (m instanceof Three) {
            ...
            var v = compare9(k)(m.value4);
            var v3 = compare9(k)(m.value1);
  ...
  foldMapWithIndex: function(dictMonoid) {
    ...
    return function(f) {
      return function(m) {
        ...
        ;
        if (m instanceof Two) {
          return append24(foldMapWithIndex(foldableWithIndexMap)(dictMonoid)(f)(m.value0))(append24(f(m.value1)(m.value2))(foldMapWithIndex(foldableWithIndexMap)(dictMonoid)(f)(m.value3)));
        }
        ;
        if (m instanceof Three) {
          return append24(foldMapWithIndex(foldableWithIndexMap)(dictMonoid)(f)(m.value0))(append24(f(m.value1)(m.value2))(append24(foldMapWithIndex(foldableWithIndexMap)(dictMonoid)(f)(m.value3))(append24(f(m.value4)(m.value5))(foldMapWithIndex(foldableWithIndexMap)(dictMonoid)(f)(m.value6)))));
        }
        ;
...
var commit = function(v) {
  return {
    buffer: foldr4(flip(foldr4(apply)))(v.buffer)(v.queue),
    queue: Nil.value
  };
};
...
var print = function(v) {
  return function(opts) {
    ...
    return function($136) {
      return $135(pure2(Doc.create($136)));
    };
  };
};
var $$break = /* @__PURE__ */ function() {
...
var intercalate5 = /* @__PURE__ */ intercalate2(foldableArray)(monoidDoc);
  ...
  return function(v) {
    ...
    if (v instanceof Just) {
      var prefixSpaces = head(sort2(mapMaybe(function(str) {
        var spaces = length4(takeWhile3(eq3(codePointFromChar(" ")))(str));
        return voidLeft2(guard3(spaces < length4(str)))(spaces);
      })(v.value0.tail)));
      ...
      if (prefixSpaces instanceof Just) {
        return new Tuple(true, withPosition(function(pos) {
          ...
          var tailDocs = map9(function(str) {
...
var flexDoubleBreak = function(v) {
  return function(v1) {
    ...
    if (otherwise) {
      ...
      ;
      return {
        doc: append3(flexSelect(docLeft)(mempty3)($$break))(append3($$break)(docRight)),
        isEmpty: v.isEmpty,
        leading: v.leading,
        multiline: true,
        trailing: v1.trailing
...
var semigroupFormatDoc = {
  append: /* @__PURE__ */ joinDoc(/* @__PURE__ */ force2(identity6))
};
...
var joinWithMap = function(dictFoldable) {
  ...
  return function(op) {
    return function(k) {
      ...
      return foldl5(go)(mempty32);
    };
  };
};
var joinWith2 = function(dictFoldable) {
  return flip(joinWithMap(dictFoldable))(identity6);
};
...
var pure3 = /* @__PURE__ */ pure(applicativeNonEmptyArray);
var append14 = /* @__PURE__ */ append(semigroupDoc);
var eq4 = /* @__PURE__ */ eq(eqForceBreak);
var mempty4 = /* @__PURE__ */ mempty(monoidDoc);
var notEq2 = /* @__PURE__ */ notEq(eqForceBreak);
...
var breaks2 = function(fl) {
  return function(n) {
    if (eq4(fl)(ForceBreak.value) || n > 0) {
      return forceBreaks(n);
    }
    ;
    if (eq4(fl)(ForceSpace.value)) {
      return space;
    }
    ;
    if (otherwise) {
...
var toFormatDoc = /* @__PURE__ */ function() {
  var realignOp = function($copy_op) {
    return function($copy_doc) {
      ...
      function $tco_loop(op, doc) {
        var v = hangHead(doc);
        if (notEq2(op.leading.left)(ForceBreak.value) && (op.leading.lines === 0 && (notEq2(op.trailing.right)(ForceBreak.value) && (notEq2(v.leading.left)(ForceBreak.value) && v.leading.lines > 0)))) {
        ...
        if (doc instanceof HangBreak) {
          var $77 = notEq2(op.trailing.right)(ForceBreak.value) && (notEq2(v.leading.left)(ForceBreak.value) && (v.leading.lines === 0 && (v.leading.multiline || op.multiline)));
          if ($77) {
            $tco_done = true;
  ...
  var flexSelectJoin = function(v) {
    return function(v1) {
      return function(v2) {
        var $$break3 = function() {
          if (eq4(v.leading.left)(ForceBreak.value) || v.leading.lines > 0) {
            return $$break;
          }
          ;
          if (otherwise) {
  ...
  var docJoin = function(v) {
    ...
    ;
    if (otherwise) {
      var $105 = eq4(v.leading.left)(ForceBreak.value) || v.leading.lines > 0;
      if ($105) {
        return v;
      }
      ;
...
var eq5 = /* @__PURE__ */ eq(/* @__PURE__ */ eqMaybe(eqModuleName));
var eq12 = /* @__PURE__ */ eq(eqOperator);
    ...
    function $tco_loop(stk, chs) {
      ...
      if (chs instanceof Cons && chs.value1 instanceof Nil) {
        ...
        if (stk instanceof OpPrec) {
          var v = compare3(chs.value0.value0)(stk.value1);
          if (v instanceof EQ) {
            $tco_done = true;
...
var eqQualifiedOperator = {
  eq: function(x) {
    return function(y) {
      return eq5(x.value0)(y.value0) && eq23(x.value1)(y.value1) && eq12(x.value2)(y.value2);
    };
  }
};
...
var union3 = /* @__PURE__ */ union2(ordTuple2);
...
var insertOperator = function(v) {
  return function(prec) {
    ...
    return alter2(function(v1) {
      ...
      ;
      if (v1 instanceof Just) {
        return new Just(insert7(opKey)(prec)(v1.value0));
      }
      ;
...
var lookupOperator = function(v) {
  return function(precMap) {
    return bind2(lookup3(v.value0)(precMap))(lookup1(new Tuple(v.value1, v.value2)));
  };
};
var remapOperatorTo = function(newModName) {
  return function(v) {
    return function(precMap) {
      return fromMaybe(precMap)(bind2(lookupOperator(v)(precMap))(function(prec) {
        return pure4(insertOperator(new QualifiedOperator(newModName, v.value1, v.value2))(prec)(precMap));
      }));
    };
  };
};
var remapModuleTo = function(newModName) {
  return function(modName) {
    return function(precMap) {
      return fromMaybe(precMap)(bind2(lookup3(new Just(modName))(precMap))(function(ops) {
        return pure4(alter2(function(v) {
          if (v instanceof Nothing) {
            return new Just(ops);
          }
          ;
          if (v instanceof Just) {
            return new Just(union3(ops)(v.value0));
          }
          ;
...
var remapModuleToHiding = function(dictFoldable) {
  var elem3 = elem(dictFoldable)(eqQualifiedOperator);
        ...
        return function(precMap) {
          return fromMaybe(precMap)(bind2(lookup3(new Just(modName))(precMap))(function(ops) {
            ...
            return pure4(alter2(function(v) {
              ...
              ;
              if (v instanceof Just) {
                return new Just(union3(filteredOps)(v.value0));
              }
              ;
...
var remapOperators = /* @__PURE__ */ function() {
  ...
  var goImportDecl = function(precMap) {
    return function(v) {
      var newModName = map10(function(v1) {
      ...
      if (v.names instanceof Just) {
        var impOps = append15(goImport(v.module.name)(v.names.value0.value1.value.head))(foldMap2(function() {
        ...
        ;
        return foldl2(flip(remapOperatorTo(newModName)))(precMap)(impOps);
      }
      ;
  ...
  var goModule = function(precMap) {
    return function(v) {
      return foldl2(goDecl(v.header.name.name))(foldl2(goImportDecl)(precMap)(v.header.imports))(v.body.decls);
    };
  };
  return goModule;
}();
    ...
    return function(init3) {
      var go = function(stk) {
        return function(v) {
          ...
          var prec = fromMaybe(defaultPrecedence)(bindFlipped2(lookup1(new Tuple(v1.value1, v1.value2)))(lookup3(v1.value0)(precMap)));
...
var foldMap3 = /* @__PURE__ */ foldMap(foldableMaybe)(monoidFormatDoc);
var joinWithMap2 = /* @__PURE__ */ joinWithMap(foldableArray);
var lines3 = /* @__PURE__ */ lines(foldableArray);
var intercalate6 = /* @__PURE__ */ intercalate3(monoidDoc);
...
var append16 = /* @__PURE__ */ append(semigroupFormatDoc);
...
var guard4 = /* @__PURE__ */ guard2(monoidFormatDoc);
var eq13 = /* @__PURE__ */ eq(eqUnicodeOption);
...
var compare4 = /* @__PURE__ */ compare(ordProper);
...
var toElseIfChain = function(ifte) {
  ...
  return go(pure5(new IfThen(ifte.keyword, ifte.cond, ifte.then, ifte["true"])))(ifte);
};
var formatString = /* @__PURE__ */ function() {
  var $1034 = foldMap3(function(v) {
...
var formatRawString = /* @__PURE__ */ function() {
  var $1036 = foldMap3(function(v) {
    ...
    })(intercalate6($$break)(map11(text)(v.tail)))]));
  });
    ...
    return function(conf) {
      ...
      var go = function(v) {
        ...
        if (v instanceof OpList) {
          return hangOps(go(v.value0))(map12(function(v1) {
  ...
  return function(k) {
    return function(format) {
      return function(conf) {
        ...
        var $1040 = foldr5(go)(Nothing.value);
...
var formatWithComments = function(leading) {
  return function(trailing) {
    return function(doc) {
      return foldr5(formatComment(leadingLineComment)(leadingBlockComment))(append16(doc)(foldr5(formatComment(trailingLineComment)(trailingBlockComment))(mempty5)(trailing)))(leading);
    };
  };
};
...
var formatEmptyList = function(conf) {
  return function(v) {
    return append16(formatToken(conf)(v.open))(formatToken(conf)(v.close));
  };
};
...
var formatExport = function(conf) {
  return function(v) {
    ...
    if (v instanceof ExportType) {
      return flexGroup2(softBreak2(formatName(conf)(v.value0))(indent2(foldMap3(formatDataMembers(conf))(v.value1))));
    }
    ;
  ...
  return function(v) {
    ...
    var importDeclBody = function() {
      if (v.names instanceof Just && v.names.value0.value0 instanceof Just) {
        return space2(flexSpaceBreak(space2(formatName(conf)(v.module))(anchor(formatToken(conf)(v.names.value0.value0.value0))))(anchor(formatParenListNonEmpty(NotGrouped.value)(formatImport)(conf)(v.names.value0.value1))))(anchor(foldMap3(formatImportQualified)(v.qualified)));
      }
      ;
      if (v.names instanceof Just && v.names.value0.value0 instanceof Nothing) {
        return space2(flexSpaceBreak(formatName(conf)(v.module))(anchor(formatParenListNonEmpty(NotGrouped.value)(formatImport)(conf)(v.names.value0.value1))))(anchor(foldMap3(formatImportQualified)(v.qualified)));
      }
      ;
      if (v.names instanceof Nothing) {
        return space2(formatName(conf)(v.module))(anchor(foldMap3(formatImportQualified)(v.qualified)));
      }
      ;
...
var formatParens = function(format) {
  return function(conf) {
    return function(v) {
      return append16(formatToken(conf)(v.open))(append16(anchor(format(conf)(v.value)))(formatToken(conf)(v.close)));
    };
  };
};
...
var formatHangingType = function(conf) {
  var $1050 = formatHangingPolytype(identity8)(conf);
  ...
  return function(conf) {
    return function(v) {
      ...
      if (conf.typeArrowPlacement instanceof TypeArrowFirst) {
        ...
        var formatPolyArrowFirst = function(k) {
          return function(v1) {
            if (v1 instanceof PolyForall) {
              ...
              return function(doc) {
                return space2(softBreak2(k(foldl13(go)(formatToken(conf)(v1.value0))(v1.value1)))(append16(guard4(!isUnicode)(fromDoc(flexAlt(mempty13)(space))))(anchor(formatToken(conf)(v1.value2)))))(anchor(alignCurrentColumn2(doc)));
              };
            }
            ;
        ...
        return hangBreak(foldl3(formatPolyArrowFirst)(ind)(v.init)(anchor(formatMonotype(conf)(v.last))));
      }
      ;
      if (conf.typeArrowPlacement instanceof TypeArrowLast) {
        var formatPolyArrowLast = function(v1) {
          if (v1 instanceof PolyForall) {
            ...
            return append16(foldl13(go)(formatToken(conf)(v1.value0))(v1.value1))(indent2(anchor(formatToken(conf)(v1.value2))));
          }
          ;
          if (v1 instanceof PolyArrow) {
...
var formatHangingMonotype = function(conf) {
  return function(v) {
    ...
    if (v instanceof TypeInt) {
      return hangBreak(append16(foldMap3(formatToken(conf))(v.value0))(formatToken(conf)(v.value1)));
    }
    ;
    ...
    if (v instanceof TypeApp) {
      return hangApp(formatHangingType(conf)(v.value0))(map12(formatHangingType(conf))(v.value1));
    }
    ;
...
var formatHangingDataCtor = function(conf) {
  return function(v) {
    ...
    ;
    if (v1 instanceof Just) {
      return hangApp(hangingName)(map12(formatHangingType(conf))(v1.value0));
    }
    ;
...
var formatConstraints = function(conf) {
  return function(v) {
    var unicodeArr = function() {
      if (v.value1.value instanceof TokOperator && (v.value1.value.value0 instanceof Nothing && (v.value1.value.value1 === "<=" && eq13(conf.unicode)(UnicodeAlways.value)))) {
        return {
      ...
      ;
      if (v.value1.value instanceof TokOperator && (v.value1.value.value0 instanceof Nothing && (v.value1.value.value1 === "\u21D0" && eq13(conf.unicode)(UnicodeNever.value)))) {
        return {
          value: new TokOperator(Nothing.value, "<="),
          leadingComments: v.value1.leadingComments,
          range: v.value1.range,
...
var formatInstanceHead = function(conf) {
  return function(v) {
    var hdTypes = spaceBreak2(foldMap3(formatConstraints(conf))(v.value0.constraints))(flexGroup2(space2(formatQualifiedName(conf)(v.value0.className))(indent2(joinWithMap2(spaceBreak2)(formatType(conf))(v.value0.types)))));
    if (v.value0.name instanceof Just) {
      return space2(flexSpaceBreak(space2(space2(formatToken(conf)(v.value0.keyword))(anchor(formatName(conf)(v.value0.name.value0.value0))))(anchor(formatToken(conf)(v.value0.name.value0.value1))))(indent2(hdTypes)))(indent2(foldMap3(formatToken(conf))(v.value1)));
    }
    ;
    if (v.value0.name instanceof Nothing) {
      return space2(flexSpaceBreak(formatToken(conf)(v.value0.keyword))(indent2(hdTypes)))(indent2(foldMap3(formatToken(conf))(v.value1)));
    }
    ;
...
var formatClassHead = function(conf) {
  return function(v) {
    ...
    return flexSpaceBreak(formatToken(conf)(v.value0.keyword))(indent2(space2(spaceBreak2(spaceBreak2(anchor(foldMap3(formatConstraints(conf))(v["value0"]["super"])))(flexGroup2(spaceBreak2(formatName(conf)(v.value0.name))(joinWithMap2(spaceBreak2)(function() {
      var $1054 = formatTypeVarBinding(conf);
      return function($1055) {
        return indent2($1054($1055));
      };
    }())(v.value0.vars)))))(flexGroup2(anchor(foldMap3(formatFundeps)(v.value0.fundeps)))))(foldMap3(formatToken(conf))(v.value1))));
  };
};
...
var sortWith1 = /* @__PURE__ */ sortWith(ordImportModuleComparison);
var sortImportsIde = function(v) {
  var toComparison = function(v12) {
    ...
    if (v12 instanceof ImportType && (v12.value1 instanceof Just && v12.value1.value0 instanceof DataEnumerated)) {
      ...
      if (v12.value1.value0.value0.value instanceof Just) {
        return new ImportTypeCmp(v12.value0.name, true, map11(function() {
          var $1056 = un2(Name);
        ...
        }())(cons2(v12.value1.value0.value0.value.value0.head)(map11(snd)(v12.value1.value0.value0.value.value0.tail))));
      }
      ;
  ...
  var v2 = unzip2(sortWith3(fst)(map12(bindFlipped3(Tuple.create)(toComparison))(cons$prime(v.value.head)(v1.value1))));
  ...
  return function(conf) {
    return function(v) {
      ...
      if (v instanceof RecordField) {
        return declareHanging(formatName(conf)(v.value0))(append16)(anchor(formatToken(conf)(v.value1)))(format(conf)(v.value2));
      }
      ;
...
var formatHangingBinder = function(conf) {
  return function(v) {
    ...
    if (v instanceof BinderNamed) {
      return hangBreak(append16(formatName(conf)(v.value0))(flexSoftBreak(anchor(formatToken(conf)(v.value1)))(indent2(formatBinder(conf)(v.value2)))));
    }
    ;
    if (v instanceof BinderConstructor) {
      ...
      ;
      if (v1 instanceof Just) {
        return hangApp(ctorName)(map12(formatHangingBinder(conf))(v1.value0));
      }
      ;
...
var formatValueBinding = function(conf) {
  return function(v) {
    if (v.guarded instanceof Unconditional) {
      ...
      }())(v.binders))))(toFormatDoc(hang(indent2(anchor(formatToken(conf)(v.guarded.value0))))(formatHangingExpr(conf)(v.guarded.value1.expr)))))(indent2(foldMap3(formatWhere(conf))(v.guarded.value1.bindings)));
    }
    ;
...
var formatLetBinding = function(conf) {
  return function(v) {
    ...
    if (v instanceof LetBindingPattern) {
      return $$break2(space2(flexGroup2(formatBinder(conf)(v.value0)))(toFormatDoc(hang(indent2(anchor(formatToken(conf)(v.value1))))(formatHangingExpr(conf)(v.value2.expr)))))(indent2(foldMap3(formatWhere(conf))(v.value2.bindings)));
    }
    ;
...
var formatHangingExpr = function(conf) {
  return function(v) {
    ...
    if (v instanceof ExprInfix) {
      return hangOps(formatHangingExpr(conf)(v.value0))(map12(function(v1) {
    ...
    if (v instanceof ExprNegate) {
      return hangBreak(append16(formatToken(conf)(v.value0))(formatExpr(conf)(v.value1)));
    }
    ;
    if (v instanceof ExprRecordAccessor) {
      return hangBreak(append16(formatExpr(conf)(v.value0.expr))(indent2(foldMap32(anchor)([formatToken(conf)(v.value0.dot), formatName(conf)(v.value0.path.head), foldMap32(function(v1) {
        return append16(anchor(formatToken(conf)(v1.value0)))(anchor(formatName(conf)(v1.value1)));
      })(v.value0.path.tail)]))));
    }
    ;
    ...
    if (v instanceof ExprApp) {
      return hangApp(formatHangingExpr(conf)(v.value0))(map12(formatHangingExpr(conf))(v.value1));
    }
    ;
    if (v instanceof ExprLambda) {
      ...
      return hang(space2(append16(formatToken(conf)(v.value0.symbol))(alignCurrentColumn2(binders)))(indent2(anchor(formatToken(conf)(v.value0.arrow)))))(formatHangingExpr(conf)(v.value0.body));
    }
    ;
    ...
    if (v instanceof ExprCase) {
      var caseHeadExprs = foldl3(function(doc) {
        return function(v1) {
          return spaceBreak2(append16(doc)(anchor(formatToken(conf)(v1.value0))))(flexGroup2(formatExpr(conf)(v1.value1)));
        };
...
var formatCaseBranch = function(conf) {
  return function(v) {
    var caseBinders = flexGroup2(foldl3(function(doc) {
      return function(v1) {
        return spaceBreak2(append16(doc)(indent2(anchor(formatToken(conf)(v1.value0)))))(flexGroup2(formatBinder(conf)(v1.value1)));
      };
    })(flexGroup2(formatBinder(conf)(v.value0.head)))(v.value0.tail));
    if (v.value1 instanceof Unconditional) {
      return $$break2(space2(caseBinders)(toFormatDoc(hang(formatToken(conf)(v.value1.value0))(formatHangingExpr(conf)(v.value1.value1.expr)))))(indent2(foldMap3(formatWhere(conf))(v.value1.value1.bindings)));
    }
    ;
...
var $lazy_formatLetGroups = /* @__PURE__ */ $runtime_lazy2("formatLetGroups", "Tidy", function() {
...
var formatDecl = function(conf) {
  return function(v) {
    ...
    if (v instanceof DeclDerive) {
      return space2(space2(formatToken(conf)(v.value0))(foldMap3(function() {
    ...
    if (v instanceof DeclSignature) {
      return formatSignature(conf)(overLabel(function() {
        ...
        return function($1088) {
          return flatten2(pure12($1087($1088)));
        };
      }())(v.value0));
    }
    ;
  ...
  return function(v) {
    ...
    var imports = function() {
      if (conf.importSort instanceof ImportSortSource) {
        return formatImports(identity8)(v.header.imports);
      }
      ;
      if (conf.importSort instanceof ImportSortIde) {
        var toComparison = function(v12) {
          var modName = nameOf(v12.module);
          var qualName = map22(function($1091) {
        ...
        var sorted = map11(snd)(sortWith1(fst)(map11(toComparison)(v.header.imports)));
        ...
        return append16(formatImports(flatten)(v1.yes))(forceMinSourceBreaks(2)(formatImports(flatten)(v1.no)));
      }
      ;
      throw new Error("Failed pattern match at Tidy (line 221, column 5 - line 252, column 18): " + [conf.importSort.constructor.name]);
    }();
    return joinWith3($$break2)([space2(anchor(formatToken(conf)(v.header.keyword)))(indent2(space2(flexSpaceBreak(anchor(formatName(conf)(v.header.name)))(anchor(foldMap3(formatParenListNonEmpty(NotGrouped.value)(formatExport)(conf))(v.header.exports))))(anchor(formatToken(conf)(v.header.where))))), forceMinSourceBreaks(2)(function() {
    ...
    }()), forceMinSourceBreaks(2)(formatTopLevelGroups(conf)(v.body.decls)), foldr5(formatComment(leadingLineComment)(leadingBlockComment))(mempty5)(v.body.trailingComments)]);
  };
};
...
var unicodeFromString = function(v) {
  if (v === "source") {
    return pure6(UnicodeSource.value);
  }
  ;
  if (v === "always") {
    return pure6(UnicodeAlways.value);
  }
  ;
  if (v === "never") {
    return pure6(UnicodeNever.value);
  }
  ;
...
var typeArrowPlacementFromString = function(v) {
  if (v === "first") {
    return pure6(TypeArrowFirst.value);
  }
  ;
  if (v === "last") {
    return pure6(TypeArrowLast.value);
  }
  ;
  return throwError2(new UnexpectedValue(id(v)));
};
var importWrapFromString = function(v) {
  if (v === "source") {
    return pure6(ImportWrapSource.value);
  }
  ;
  if (v === "auto") {
    return pure6(ImportWrapAuto.value);
  }
  ;
  return throwError2(new UnexpectedValue(id(v)));
};
var importSortFromString = function(v) {
  if (v === "source") {
    return pure6(ImportSortSource.value);
  }
  ;
  if (v === "ide") {
    return pure6(ImportSortIde.value);
  }
  ;
  return throwError2(new UnexpectedValue(id(v)));
};
...
var insertLayout = function(v) {
  return function(nextPos) {
    return function(stack) {
      ...
      return insert8(new Tuple(stack, []));
    };
  };
};
...
var foldMap4 = /* @__PURE__ */ foldMap(foldableMaybe)(monoidString);
...
var string = function(mkErr) {
  return function(match2) {
    return function(str) {
      var $139 = take3(length4(match2))(str) === match2;
      if ($139) {
        return new LexSucc(match2, drop3(length4(match2))(str));
      }
      ;
...
var map13 = /* @__PURE__ */ map(functorLex);
var spaceComment = /* @__PURE__ */ function() {
  return map13(length4)(regex2(LexExpected.create("spaces"))(" +"));
}();
...
var char$prime = function(mkErr) {
  return function(res) {
    return function(match2) {
      return function(str) {
        var $153 = singleton6(match2) === take3(1)(str);
        if ($153) {
...
var $$char = function(mkErr) {
  return function(match2) {
    return function(str) {
      var $154 = singleton6(match2) === take3(1)(str);
      if ($154) {
        return new LexSucc(match2, drop3(1)(str));
      }
      ;
      return new LexFail(function(v) {
        return mkErr(mkUnexpected(str));
...
var apply4 = /* @__PURE__ */ apply2(applyLex);
var bindLex = {
  bind: function(v) {
    return function(k) {
      return function(str) {
...
var leadingComments = /* @__PURE__ */ function() {
  return many(alt2(map13(Comment.create)(comment))(alt2(map13(Space.create)(spaceComment))(lineComment)));
}();
var token = /* @__PURE__ */ function() {
  ...
  var parseSymbol2 = map13(function(v) {
    return function(v1) {
      if (v1 instanceof Nothing) {
        if (v === "->") {
  ...
  var parseStringSpaceEscape = map13(function(v) {
    return {
      raw: v,
      string: ""
    };
  })(stringSpaceEscapeRegex);
  var parseStringChars = map13(function(v) {
    return {
      raw: v,
      string: v
    };
  })(stringCharsRegex);
  var parseRawString = map13(function(v) {
    return new TokRawString(dropRight(3)(drop3(3)(v)));
  })(rawStringCharsRegex);
  var parseProper2 = regex2(LexExpected.create("proper name"))("\\p{Lu}[\\p{L}0-9_']*");
  var parseUpper = map13(flip(TokUpperName.create))(parseProper2);
  var parseOperator2 = map13(function(v) {
    return function(v1) {
      if (v1 instanceof Nothing) {
        if (v === "<-") {
  ...
  var parseLower = map13(function(v) {
    return function(v1) {
      if (v1 instanceof Nothing) {
        if (v === "forall") {
  ...
  var parseName = alt2(parseLower)(alt2(parseUpper)(alt2(parseOperator2)(parseSymbol2)));
  var parseModuleName2 = apply4(map13(function(v) {
    return function(v1) {
  ...
  var parseExponentPart = apply4(map13(function(v) {
    return function(v1) {
      return {
        sign: v,
        exponent: v1
  ...
  var parseHexEscape = bind1(hexEscapeRegex)(function(esc) {
    var v = bindFlipped5(fromCharCode3)(fromStringAs(hexadecimal)(esc));
    if (v instanceof Just) {
      return pure13({
        raw: "\\x" + esc,
        "char": v.value0
  ...
  var parseHole2 = map13(function(v) {
    return new TokHole(v);
  })($$try3(applySecond2(charQuestionMark)(alt2(parseIdent2)(parseProper2))));
  ...
  var parseNumber2 = bind1(intPartRegex)(function(intPart) {
    return bind1(parseNumberFractionPart)(function(fractionPart) {
      return bind1(parseNumberExponentPart)(function(exponentPart) {
        ...
        ;
        var raw = intPart + (foldMap4(function(fr) {
          return "." + fr;
        })(fractionPart) + foldMap4(function(ex) {
  ...
  var parseNumericLiteral = alt2(parseHexInt)(parseNumber2);
  ...
  var parseChar2 = bind1(charAny)(function(ch) {
    if (ch === "\\") {
      return parseEscape;
    }
    ;
  ...
  var parseString2 = map13(function(v) {
    var v1 = fold12(v);
  ...
  return alt2(parseHole2)(alt2(parseModuleName2)(alt2(parseCharLiteral)(alt2(parseStringLiteral)(alt2(parseNumericLiteral)(alt2(tokenLeftParen)(alt2(tokenRightParen)(alt2(tokenLeftBrace)(alt2(tokenRightBrace)(alt2(tokenLeftSquare)(alt2(tokenRightSquare)(alt2(tokenTick)(tokenComma))))))))))));
}();
var trailingComments = /* @__PURE__ */ function() {
  return many(alt2(map13(Comment.create)(comment))(map13(Space.create)(spaceComment)));
}();
var lexWithState = /* @__PURE__ */ function() {
  var token$prime = apply4(apply4(map13(function(v) {
    return function(v1) {
      return function(v2) {
        return {
          token: v,
...
var pure7 = /* @__PURE__ */ pure(applicativeParser);
var altParser = {
  alt: function(v) {
    return function(v1) {
      return function(state1, more, resume, done) {
  ...
  return function(v) {
    return function(state1, more, resume, done) {
      return v({
        ...
        errors: state1.errors,
        stream: state1.stream
      }, more, function(state2, error2) {
        var v1 = k(error2)(state1.stream);
        if (v1 instanceof Nothing) {
          return resume({
            consumed: state1.consumed,
            errors: state2.errors,
        ...
        if (v1 instanceof Just) {
          return done({
            consumed: true,
            errors: snoc(state2.errors)(error2),
...
var optional3 = function(p) {
  return alt3(map14(Just.create)(p))(pure7(Nothing.value));
};
var many2 = function(v) {
  return function(state1, more, resume, done) {
    var $lazy_go = $runtime_lazy4("go", "PureScript.CST.Parser.Monad", function() {
...
var lookAhead = function(v) {
  return function(state1, more, resume, done) {
    return v(state1, more, function(v1, error2) {
      return resume(state1, error2);
    }, function(v1, value) {
...
var apply5 = /* @__PURE__ */ apply2(applyParser);
var map15 = /* @__PURE__ */ map(functorParser);
...
var bindFlipped6 = /* @__PURE__ */ bindFlipped(bindParser);
var defer4 = /* @__PURE__ */ defer(lazyParser);
var wrapped = function(openTok) {
  return function(closeTok) {
    return function(valueParser) {
      return bind3(openTok)(function(open2) {
        return bind3(valueParser)(function(value) {
...
var separated = function(sepParser) {
  return function(valueParser) {
    return apply5(map15(function(v) {
      return function(v1) {
        return {
          head: v,
          tail: v1
    ...
    })(valueParser))(many2(apply5(map15(Tuple.create)(sepParser))(valueParser)));
  };
};
var reservedKeywords = /* @__PURE__ */ fromFoldable4(foldableArray)(ordString)(["ado", "case", "class", "data", "derive", "do", "else", "false", "foreign", "if", "import", "in", "infix", "infixl", "infixr", "instance", "let", "module", "newtype", "of", "then", "true", "type", "where"]);
...
var many1 = function(parser) {
  return apply5(map15(cons$prime)(parser))(many2(parser));
};
...
var parseRecordAccessor = function(expr) {
  return bind3(tokDot)(function(dot) {
    return bind3(separated(tokDot)(parseLabel))(function(path) {
      return pure8(new ExprRecordAccessor({
        expr,
        dot,
        path
      }));
...
var parseInstanceName = /* @__PURE__ */ function() {
  return apply5(map15(Tuple.create)(parseIdent))(tokDoubleColon);
}();
...
var parseBinderNegative = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyOperator("-"))(function(negative) {
  return alt4(map15(uncurry(BinderInt.create(new Just(negative))))($$parseInt))(map15(uncurry(BinderNumber.create(new Just(negative))))(parseNumber));
});
var parseRecordLabeled = function(valueParser) {
  var parseRecordField = apply5(map15(uncurry(RecordField.create))($$try4(apply5(map15(Tuple.create)(parseLabel))(tokKeyOperator(":")))))(valueParser);
  return alt4(parseRecordField)(map15(RecordPun.create)(parseIdent));
};
var parseTypeNegative = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyOperator("-"))(function(negative) {
  return map15(uncurry(TypeInt.create(new Just(negative))))($$parseInt);
});
...
var parseFixityKeyword = /* @__PURE__ */ function() {
  return alt4(map15(flip(Tuple.create)(Infix.value))(tokKeyword("infix")))(alt4(map15(flip(Tuple.create)(Infixl.value))(tokKeyword("infixl")))(map15(flip(Tuple.create)(Infixr.value))(tokKeyword("infixr"))));
}();
var parseFixityOp = /* @__PURE__ */ function() {
  return alt4(apply5(apply5(apply5(map15(FixityType.create)(tokKeyword("type")))(parseQualifiedProper))(tokKeyword("as")))(parseOperator))(apply5(apply5(map15(FixityValue.create)(parseQualifiedIdentOrProper))(tokKeyword("as")))(parseOperator));
}();
var parseDeclFixity = /* @__PURE__ */ bind3(parseFixityKeyword)(function(keyword) {
  return bind3(parseSmallInt)(function(prec) {
    return bind3(parseFixityOp)(function(operator) {
      return pure8(new DeclFixity({
        keyword,
        prec,
        operator
      }));
...
var parseForeignKind = /* @__PURE__ */ function() {
  return $$try4(apply5(map15(ForeignKind.create)(tokKeyword("kind")))(parseProper));
}();
var parseRole = /* @__PURE__ */ function() {
  return alt4(map15(flip(Tuple.create)(Representational.value))(tokKeyword("representational")))(alt4(map15(flip(Tuple.create)(Nominal.value))(tokKeyword("nominal")))(map15(flip(Tuple.create)(Phantom.value))(tokKeyword("phantom"))));
}();
var parseDeclRole = function(keyword1) {
  return bind3(tokKeyword("role"))(function(keyword2) {
    return bind3(parseProper)(function(name2) {
      return bind3(many1(parseRole))(function(roles) {
        return pure8(new DeclRole(keyword1, keyword2, name2, roles));
      });
    });
  });
};
...
var layout = function(valueParser) {
  var tail4 = many2(applySecond3(tokLayoutSep)(valueParser));
  var go = function(head5) {
    return map15(cons2(head5))(tail4);
  };
  var values = alt4(bindFlipped6(go)(valueParser))(pure8([]));
  return applyFirst3(applySecond3(tokLayoutStart)(values))(tokLayoutEnd);
};
...
var parseFundep = /* @__PURE__ */ function() {
  return alt4(apply5(map15(FundepDetermined.create)(tokRightArrow))(many1(parseIdent)))(apply5(apply5(map15(FundepDetermines.create)(many1(parseIdent)))(tokRightArrow))(many1(parseIdent)));
}();
  ...
  return function(closeTok) {
    return function(sepTok) {
      return function(valueParser) {
        ...
        return bind3(openTok)(function(open2) {
          return alt4(parseEmpty(open2))(parseNonEmpty(open2));
        });
      };
    };
  };
...
var parseDataMembers = /* @__PURE__ */ function() {
  return alt4(map15(DataAll.create)(tokKeySymbol("..")))(map15(DataEnumerated.create)(delimited(tokLeftParen)(tokRightParen)(tokComma)(parseProper)));
}();
var parseExport = /* @__PURE__ */ function() {
  return alt4(apply5(map15(ExportTypeOp.create)(tokKeyword("type")))(parseSymbol))(alt4(apply5(map15(ExportClass.create)(tokKeyword("class")))(parseProper))(alt4(apply5(map15(ExportModule.create)(tokKeyword("module")))(parseModuleName))(alt4(map15(ExportOp.create)(parseSymbol))(alt4(map15(ExportValue.create)(parseIdent))(apply5(map15(ExportType.create)(parseProper))(optional3(parseDataMembers)))))));
}();
var parseImport = /* @__PURE__ */ function() {
  return alt4(map15(ImportOp.create)(parseSymbol))(alt4(apply5(map15(ImportType.create)(parseProper))(optional3(parseDataMembers)))(alt4(apply5(map15(ImportTypeOp.create)(tokKeyword("type")))(parseSymbol))(alt4(apply5(map15(ImportClass.create)(tokKeyword("class")))(parseProper))(map15(ImportValue.create)(parseIdent)))));
}();
var parseImportDecl = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("import"))(function(keyword) {
  return bind3(parseModuleName)(function(module_) {
    return bind3(optional3(apply5(map15(Tuple.create)(optional3(tokKeyword("hiding"))))(parens(separated(tokComma)(parseImport)))))(function(names) {
      return bind3(optional3(apply5(map15(Tuple.create)(tokKeyword("as")))(parseModuleName)))(function(qualified) {
        return pure8({
          keyword,
          module: module_,
          names,
...
var parseModuleImportDecls = /* @__PURE__ */ many2(/* @__PURE__ */ applyFirst3(parseImportDecl)(/* @__PURE__ */ alt4(tokLayoutSep)(/* @__PURE__ */ lookAhead(tokLayoutEnd))));
var parseModuleHeader = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("module"))(function(keyword) {
  return bind3(parseModuleName)(function(name2) {
    return bind3(optional3(parens(separated(tokComma)(parseExport))))(function(exports) {
      return bind3(tokKeyword("where"))(function(where_) {
        return bind3(applySecond3(tokLayoutStart)(parseModuleImportDecls))(function(imports) {
          return pure8({
            keyword,
            name: name2,
            exports,
...
var parseTypeParen = function(open2) {
  return bind3($lazy_parseType(515))(function(value) {
    return bind3(tokRightParen)(function(close2) {
      return pure8(new TypeParens({
        open: open2,
        value,
        close: close2
      }));
...
var parseRowTailParen = function(open2) {
  return bind3(apply5(map15(Tuple.create)(tokPipe))($lazy_parseType(485)))(function(tail4) {
    return bind3(tokRightParen)(function(close2) {
      return pure8(new TypeRow({
        open: open2,
        value: {
...
var parseRowParen = function(open2) {
  return bind3($$try4(apply5(map15(Tuple.create)(parseLabel))(tokDoubleColon)))(function(v) {
    return bind3($lazy_parseType(467))(function(value) {
      return bind3(many2(apply5(map15(Tuple.create)(tokComma))($lazy_parseRowLabel(468))))(function(rest) {
        return bind3(optional3(apply5(map15(Tuple.create)(tokPipe))($lazy_parseType(469))))(function(tail4) {
          return bind3(tokRightParen)(function(close2) {
            return pure8(new TypeRow({
              open: open2,
              value: {
...
var parseKindedVar = function(open2) {
  return bind3($$try4(apply5(map15(Tuple.create)(parens(map15(TypeVar.create)(parseIdent))))(tokDoubleColon)))(function(v) {
    return bind3($lazy_parseType(505))(function(kind) {
      return bind3(tokRightParen)(function(close2) {
        return pure8(new TypeParens({
          open: open2,
...
var $lazy_parseForall = /* @__PURE__ */ $runtime_lazy5("parseForall", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return apply5(apply5(apply5(map15(TypeForall.create)(tokForall))(many1($lazy_parseTypeVarBinding(536))))(tokDot))($lazy_parseType1(538));
  });
});
var $lazy_parseRow = /* @__PURE__ */ $runtime_lazy5("parseRow", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3(optional3(separated(tokComma)($lazy_parseRowLabel(521))))(function(labels) {
      return bind3(optional3(apply5(map15(Tuple.create)(tokPipe))($lazy_parseType(522))))(function(tail4) {
        return pure8({
          labels,
          tail: tail4
        });
...
var $lazy_parseRowLabel = /* @__PURE__ */ $runtime_lazy5("parseRowLabel", "PureScript.CST.Parser", function() {
  return bind3(parseLabel)(function(label) {
    return bind3(tokDoubleColon)(function(separator) {
      return bind3($lazy_parseType(529))(function(value) {
        return pure8({
          label,
          separator,
          value
...
var $lazy_parseType = /* @__PURE__ */ $runtime_lazy5("parseType", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseType1(401))(function(ty) {
      return alt4(apply5(map15(TypeKinded.create(ty))(tokDoubleColon))($lazy_parseType(402)))(pure8(ty));
    });
  });
});
var $lazy_parseType1 = /* @__PURE__ */ $runtime_lazy5("parseType1", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4($lazy_parseForall(407))($lazy_parseType2(408));
  });
});
var $lazy_parseType2 = /* @__PURE__ */ $runtime_lazy5("parseType2", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseType3(412))(function(ty) {
      return alt4(apply5(map15(TypeArrow.create(ty))(tokRightArrow))($lazy_parseType1(413)))(alt4(apply5(map15(TypeConstrained.create(ty))(tokRightFatArrow))($lazy_parseType1(414)))(pure8(ty)));
    });
  });
});
var $lazy_parseType3 = /* @__PURE__ */ $runtime_lazy5("parseType3", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseType4(419))(function(ty) {
      return bind3(many2(apply5(map15(Tuple.create)(parseQualifiedOperator))($lazy_parseType4(420))))(function(ops) {
...
var $lazy_parseType4 = /* @__PURE__ */ $runtime_lazy5("parseType4", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4(parseTypeNegative)($lazy_parseType5(427));
  });
});
var $lazy_parseType5 = /* @__PURE__ */ $runtime_lazy5("parseType5", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseTypeAtom(431))(function(ty) {
      return bind3(many2($lazy_parseTypeAtom(432)))(function(args) {
        return pure8(function() {
...
var $lazy_parseTypeAtom = /* @__PURE__ */ $runtime_lazy5("parseTypeAtom", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4(map15(TypeVar.create)(parseIdent))(alt4(map15(TypeConstructor.create)(parseQualifiedProper))(alt4(map15(uncurry(TypeString.create))(parseString))(alt4(map15(uncurry(TypeInt.create(Nothing.value)))($$parseInt))(alt4($lazy_parseTypeParens(443))(alt4(map15(TypeRecord.create)(braces($lazy_parseRow(444))))(alt4(map15(TypeOpName.create)(parseQualifiedSymbol))(alt4(map15(TypeHole.create)(parseHole))(alt4(map15(TypeWildcard.create)(tokUnderscore))(map15(TypeArrowName.create)(tokSymbolArrow))))))))));
  });
});
var $lazy_parseTypeParens = /* @__PURE__ */ $runtime_lazy5("parseTypeParens", "PureScript.CST.Parser", function() {
  return bind3(tokLeftParen)(function(open2) {
    return alt4(parseRowParen(open2))(alt4(parseRowTailParen(open2))(alt4(parseKindedVar(open2))(alt4(parseTypeParen(open2))(parseEmptyRow(open2)))));
  });
});
var $lazy_parseTypeVarBinding = /* @__PURE__ */ $runtime_lazy5("parseTypeVarBinding", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4($lazy_parseTypeVarKinded(542))(map15(TypeVarName.create)(parseIdent));
  });
});
var $lazy_parseTypeVarKinded = /* @__PURE__ */ $runtime_lazy5("parseTypeVarKinded", "PureScript.CST.Parser", function() {
  return map15(TypeVarKinded.create)(parens(bind3(parseIdent)(function(label) {
    return bind3(tokDoubleColon)(function(separator) {
      return bind3($lazy_parseType(549))(function(value) {
        return pure8({
          label,
          separator,
          value
...
var parseDataCtor = /* @__PURE__ */ apply5(/* @__PURE__ */ map15(function(v) {
  return function(v1) {
    return {
      name: v,
      fields: v1
...
var $lazy_parseBinder = /* @__PURE__ */ $runtime_lazy5("parseBinder", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseBinder1(806))(function(binder) {
      return alt4(apply5(map15(BinderTyped.create(binder))(tokDoubleColon))(parseType))(pure8(binder));
    });
  });
});
var $lazy_parseBinder1 = /* @__PURE__ */ $runtime_lazy5("parseBinder1", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseBinder2(812))(function(binder) {
      return bind3(many2(apply5(map15(Tuple.create)(parseQualifiedOperator))($lazy_parseBinder2(813))))(function(ops) {
        return pure8(function() {
          var v1 = fromArray(ops);
          if (v1 instanceof Nothing) {
            return binder;
...
var $lazy_parseBinder2 = /* @__PURE__ */ $runtime_lazy5("parseBinder2", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4(parseBinderNegative)(alt4($lazy_parseBinderConstructor(821))($lazy_parseBinderAtom(822)));
  });
});
var $lazy_parseBinderAtom = /* @__PURE__ */ $runtime_lazy5("parseBinderAtom", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4($lazy_parseIdentBinder(838))(alt4(map15(flip(BinderConstructor.create)([]))(parseQualifiedProper))(alt4(map15(BinderWildcard.create)(tokUnderscore))(alt4(map15(uncurry(BinderString.create))(parseString))(alt4(map15(uncurry(BinderChar.create))(parseChar))(alt4(map15(uncurry(BinderBoolean.create))(parseBoolean))(alt4(map15(uncurry(BinderInt.create(Nothing.value)))($$parseInt))(alt4(map15(uncurry(BinderNumber.create(Nothing.value)))(parseNumber))(alt4(map15(BinderArray.create)(delimited(tokLeftSquare)(tokRightSquare)(tokComma)($lazy_parseBinder(846))))(alt4(map15(BinderRecord.create)(delimited(tokLeftBrace)(tokRightBrace)(tokComma)(parseRecordLabeled($lazy_parseBinder(847)))))(map15(BinderParens.create)(parens($lazy_parseBinder(848)))))))))))));
  });
});
var $lazy_parseBinderConstructor = /* @__PURE__ */ $runtime_lazy5("parseBinderConstructor", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3(parseQualifiedProper)(function(name2) {
      return bind3(many2($lazy_parseBinderAtom(833)))(function(apps) {
        return pure8(new BinderConstructor(name2, apps));
      });
    });
  });
});
var $lazy_parseIdentBinder = /* @__PURE__ */ $runtime_lazy5("parseIdentBinder", "PureScript.CST.Parser", function() {
  return bind3(parseIdent)(function(ident) {
    return alt4(apply5(map15(BinderNamed.create(ident))(tokAt))($lazy_parseBinderAtom(853)))(pure8(new BinderVar(ident)));
  });
});
...
var parseClassConstraints = function(parseOneConstraint) {
  return alt4(map15(Many.create)(parens(separated(tokComma)(parseType))))(map15(One.create)(parseOneConstraint));
};
var parseDeclDerive = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("derive"))(function(derive_) {
  return bind3(optional3(tokKeyword("newtype")))(function(newtype_) {
    return bind3(tokKeyword("instance"))(function(keyword) {
      return bind3(optional3(parseInstanceName))(function(name2) {
        return bind3(optional3($$try4(apply5(map15(Tuple.create)(parseClassConstraints(parseType3)))(tokRightFatArrow))))(function(constraints) {
          return bind3(parseQualifiedProper)(function(className) {
            return bind3(many2(parseTypeAtom))(function(types) {
              return pure8(new DeclDerive(derive_, newtype_, {
                keyword,
                name: name2,
                constraints,
                className,
...
var parseClassMember = /* @__PURE__ */ bind3(parseIdent)(function(label) {
  return bind3(tokDoubleColon)(function(separator) {
    return bind3(parseType)(function(value) {
      return pure8({
        label,
        separator,
        value
...
var parseDeclClassSignature = function(keyword) {
  return bind3($$try4(apply5(map15(Tuple.create)(parseProper))(tokDoubleColon)))(function(v) {
    return bind3(parseType)(function(value) {
      return pure8(new DeclKindSignature(keyword, {
        label: v.value0,
        separator: v.value1,
        value
      }));
...
var parseDeclSignature = function(label) {
  return bind3(tokDoubleColon)(function(separator) {
    return bind3(parseType)(function(value) {
      return pure8(new DeclSignature({
        label,
        separator,
        value
      }));
...
var parseForeignData = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("data"))(function(keyword) {
  return bind3(parseProper)(function(label) {
    return bind3(tokDoubleColon)(function(separator) {
      return bind3(parseType)(function(value) {
        return pure8(new ForeignData(keyword, {
          label,
          separator,
          value
        }));
...
var parseForeignValue = /* @__PURE__ */ bind3(parseIdent)(function(label) {
  return bind3(tokDoubleColon)(function(separator) {
    return bind3(parseType)(function(value) {
      return pure8(new ForeignValue({
        label,
        separator,
        value
      }));
...
var parseDeclForeign = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("foreign"))(function(keyword1) {
  return bind3(tokKeyword("import"))(function(keyword2) {
    return bind3(alt4(parseForeignData)(alt4(parseForeignKind)(parseForeignValue)))(function(foreign_) {
      return pure8(new DeclForeign(keyword1, keyword2, foreign_));
    });
  });
});
var parseInstanceBindingSignature = function(label) {
  return bind3(tokDoubleColon)(function(separator) {
    return bind3(parseType)(function(value) {
      return pure8(new InstanceBindingSignature({
        label,
        separator,
        value
      }));
...
var parseLetBindingSignature = function(label) {
  return bind3(tokDoubleColon)(function(separator) {
    return bind3(parseType)(function(value) {
      return pure8(new LetBindingSignature({
        label,
        separator,
        value
      }));
...
var parseRecordUpdates = function(expr) {
  return bind3($$try4(applyFirst3(tokLeftBrace)(lookAhead(applySecond3(parseLabel)(alt4(tokEquals)(tokLeftBrace))))))(function(open2) {
    return bind3(separated(tokComma)($lazy_parseRecordUpdate(690)))(function(value) {
      return bind3(tokRightBrace)(function(close2) {
        return pure8(new ExprRecordUpdate(expr, {
          open: open2,
          value,
          close: close2
        }));
...
var parseRecordUpdateLeaf = function(label) {
  return apply5(map15(RecordUpdateLeaf.create(label))(tokEquals))($lazy_parseExpr(704));
};
var parseRecordUpdateBranch = function(label) {
  return map15(RecordUpdateBranch.create(label))(braces(separated(tokComma)($lazy_parseRecordUpdate(709))));
};
var parseLetBindingName = function(name2) {
  return bind3(many2(parseBinderAtom))(function(binders) {
    return bind3(parseGuarded(tokEquals))(function(guarded) {
      return pure8(new LetBindingName({
        name: name2,
        binders,
        guarded
      }));
...
var parseGuarded = function(sepParser) {
  var parsePatternGuard = apply5(map15(function(v) {
    return function(v1) {
      return {
        binder: v,
        expr: v1
  ...
  })(optional3($$try4(apply5(map15(Tuple.create)(parseBinder))(tokLeftArrow)))))($lazy_parseExpr(795));
  var parseGuardedExpr = apply5(apply5(apply5(map15(function(v) {
    return function(v1) {
      return function(v2) {
        return function(v3) {
          return {
  ...
  return alt4(apply5(map15(Unconditional.create)(sepParser))($lazy_parseWhere(781)))(map15(Guarded.create)(many1(parseGuardedExpr)));
};
var parseBadSingleCaseWhere = function(binder) {
  return bind3(tokRightArrow)(function(arrow) {
    return bind3(applySecond3(tokLayoutEnd)($lazy_parseWhere(659)))(function(body) {
      return pure8(singleton4(new Tuple({
        head: binder,
        tail: []
...
var parseBadSingleCaseGuarded = function(binder) {
  return bind3(applySecond3(tokLayoutEnd)(parseGuarded(tokRightArrow)))(function(body) {
    return pure8(singleton4(new Tuple({
      head: binder,
      tail: []
    }, body)));
...
var $lazy_parseAdo = /* @__PURE__ */ $runtime_lazy5("parseAdo", "PureScript.CST.Parser", function() {
  return bind3(tokQualifiedKeyword("ado"))(function(keyword) {
    return bind3(layout(recoverDoStatement($lazy_parseDoStatement(676))))(function(statements) {
      return bind3(tokKeyword("in"))(function(in_) {
        return bind3($lazy_parseExpr(678))(function(result) {
          return pure8(new ExprAdo({
            keyword,
            statements,
            "in": in_,
            result
...
var $lazy_parseBadSingleCaseBranch = /* @__PURE__ */ $runtime_lazy5("parseBadSingleCaseBranch", "PureScript.CST.Parser", function() {
  return bind3(applySecond3(tokLayoutStart)(parseBinder1))(function(binder) {
    return alt4(parseBadSingleCaseWhere(binder))(parseBadSingleCaseGuarded(binder));
  });
});
var $lazy_parseCase = /* @__PURE__ */ $runtime_lazy5("parseCase", "PureScript.CST.Parser", function() {
  return bind3(tokKeyword("case"))(function(keyword) {
    return bind3(separated(tokComma)($lazy_parseExpr(641)))(function(head5) {
      return bind3(tokKeyword("of"))(function(of_) {
        return bind3(alt4($$try4($lazy_parseBadSingleCaseBranch(643)))($lazy_parseCaseBranches(643)))(function(branches) {
          return pure8(new ExprCase({
            keyword,
            head: head5,
            of: of_,
            branches
...
var $lazy_parseCaseBranches = /* @__PURE__ */ $runtime_lazy5("parseCaseBranches", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return layoutNonEmpty(apply5(map15(Tuple.create)(separated(tokComma)(parseBinder1)))(parseGuarded(tokRightArrow)));
  });
});
var $lazy_parseDo = /* @__PURE__ */ $runtime_lazy5("parseDo", "PureScript.CST.Parser", function() {
  return bind3(tokQualifiedKeyword("do"))(function(keyword) {
    return bind3(layoutNonEmpty(recoverDoStatement($lazy_parseDoStatement(670))))(function(statements) {
      return pure8(new ExprDo({
        keyword,
        statements
      }));
    });
...
var $lazy_parseDoStatement = /* @__PURE__ */ $runtime_lazy5("parseDoStatement", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4(apply5(map15(DoLet.create)(tokKeyword("let")))(layoutNonEmpty(recoverLetBinding($lazy_parseLetBinding(752)))))(alt4(apply5(map15(uncurry(DoBind.create))($$try4(apply5(map15(Tuple.create)(parseBinder))(tokLeftArrow))))($lazy_parseExpr(753)))(map15(DoDiscard.create)($lazy_parseExpr(754))));
  });
});
var $lazy_parseExpr = /* @__PURE__ */ $runtime_lazy5("parseExpr", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseExpr1(554))(function(expr) {
      return alt4(apply5(map15(ExprTyped.create(expr))(tokDoubleColon))(parseType))(pure8(expr));
    });
  });
});
var $lazy_parseExpr1 = /* @__PURE__ */ $runtime_lazy5("parseExpr1", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseExpr2(560))(function(expr) {
      return bind3(many2(apply5(map15(Tuple.create)(parseQualifiedOperator))($lazy_parseExpr2(561))))(function(ops) {
        return pure8(function() {
          var v1 = fromArray(ops);
          if (v1 instanceof Nothing) {
            return expr;
...
var $lazy_parseExpr2 = /* @__PURE__ */ $runtime_lazy5("parseExpr2", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseExpr3(568))(function(expr) {
      return bind3(many2(apply5(map15(Tuple.create)($lazy_parseTickExpr(569)))($lazy_parseExpr3(569))))(function(ops) {
        return pure8(function() {
          var v1 = fromArray(ops);
          if (v1 instanceof Nothing) {
            return expr;
...
var $lazy_parseExpr3 = /* @__PURE__ */ $runtime_lazy5("parseExpr3", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4(apply5(map15(ExprNegate.create)(tokKeyOperator("-")))($lazy_parseExpr3(591)))($lazy_parseExpr4(592));
  });
});
var $lazy_parseExpr4 = /* @__PURE__ */ $runtime_lazy5("parseExpr4", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseExpr5(596))(function(expr) {
      return bind3(many2($lazy_parseExpr5(597)))(function(args) {
        return pure8(function() {
          var v1 = fromArray(args);
          if (v1 instanceof Nothing) {
            return expr;
...
var $lazy_parseExpr5 = /* @__PURE__ */ $runtime_lazy5("parseExpr5", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4($lazy_parseIf(604))(alt4($lazy_parseLetIn(605))(alt4($lazy_parseLambda(606))(alt4($lazy_parseCase(607))(alt4($lazy_parseDo(608))(alt4($lazy_parseAdo(609))($lazy_parseExpr6(610)))))));
  });
});
var $lazy_parseExpr6 = /* @__PURE__ */ $runtime_lazy5("parseExpr6", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseExpr7(683))(function(expr) {
      return alt4(parseRecordUpdates(expr))(pure8(expr));
    });
  });
});
var $lazy_parseExpr7 = /* @__PURE__ */ $runtime_lazy5("parseExpr7", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseExprAtom(713))(function(expr) {
      return alt4(parseRecordAccessor(expr))(pure8(expr));
    });
  });
});
var $lazy_parseExprAtom = /* @__PURE__ */ $runtime_lazy5("parseExprAtom", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4(map15(ExprIdent.create)(parseQualifiedIdent))(alt4(map15(ExprConstructor.create)(parseQualifiedProper))(alt4(map15(ExprOpName.create)(parseQualifiedSymbol))(alt4(map15(ExprSection.create)(tokUnderscore))(alt4(map15(ExprHole.create)(parseHole))(alt4(map15(uncurry(ExprString.create))(parseString))(alt4(map15(uncurry(ExprChar.create))(parseChar))(alt4(map15(uncurry(ExprBoolean.create))(parseBoolean))(alt4(map15(uncurry(ExprInt.create))($$parseInt))(alt4(map15(uncurry(ExprNumber.create))(parseNumber))(alt4(map15(ExprArray.create)(delimited(tokLeftSquare)(tokRightSquare)(tokComma)($lazy_parseExpr(735))))(alt4(map15(ExprRecord.create)(delimited(tokLeftBrace)(tokRightBrace)(tokComma)(parseRecordLabeled($lazy_parseExpr(736)))))(map15(ExprParens.create)(parens($lazy_parseExpr(737)))))))))))))));
  });
});
var $lazy_parseIdentBinding = /* @__PURE__ */ $runtime_lazy5("parseIdentBinding", "PureScript.CST.Parser", function() {
  return bind3(parseIdent)(function(ident) {
    return alt4(parseLetBindingSignature(ident))(parseLetBindingName(ident));
  });
});
var $lazy_parseIf = /* @__PURE__ */ $runtime_lazy5("parseIf", "PureScript.CST.Parser", function() {
  return bind3(tokKeyword("if"))(function(keyword) {
    return bind3($lazy_parseExpr(615))(function(cond) {
      return bind3(tokKeyword("then"))(function(then_) {
        return bind3($lazy_parseExpr(617))(function(true_) {
          return bind3(tokKeyword("else"))(function(else_) {
            return bind3($lazy_parseExpr(619))(function(false_) {
              return pure8(new ExprIf({
                keyword,
                cond,
                then: then_,
                "true": true_,
...
var $lazy_parseLambda = /* @__PURE__ */ $runtime_lazy5("parseLambda", "PureScript.CST.Parser", function() {
  return bind3(tokBackslash)(function(symbol) {
    return bind3(many1(parseBinderAtom))(function(binders) {
      return bind3(tokRightArrow)(function(arrow) {
        return bind3($lazy_parseExpr(635))(function(body) {
          return pure8(new ExprLambda({
            symbol,
            binders,
            arrow,
            body
...
var $lazy_parseLetBinding = /* @__PURE__ */ $runtime_lazy5("parseLetBinding", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return alt4($$try4($lazy_parseIdentBinding(758)))(apply5(apply5(map15(LetBindingPattern.create)(parseBinder1))(tokEquals))($lazy_parseWhere(759)));
  });
});
var $lazy_parseLetIn = /* @__PURE__ */ $runtime_lazy5("parseLetIn", "PureScript.CST.Parser", function() {
  return bind3(tokKeyword("let"))(function(keyword) {
    return bind3(layoutNonEmpty(recoverLetBinding($lazy_parseLetBinding(625))))(function(bindings) {
      return bind3(tokKeyword("in"))(function(in_) {
        return bind3($lazy_parseExpr(627))(function(body) {
          return pure8(new ExprLet({
            keyword,
            bindings,
            "in": in_,
            body
...
var $lazy_parseRecordUpdate = /* @__PURE__ */ $runtime_lazy5("parseRecordUpdate", "PureScript.CST.Parser", function() {
  return bind3(parseLabel)(function(label) {
    return alt4(parseRecordUpdateLeaf(label))(parseRecordUpdateBranch(label));
  });
});
var $lazy_parseTickExpr = /* @__PURE__ */ $runtime_lazy5("parseTickExpr", "PureScript.CST.Parser", function() {
  return bind3(tokTick)(function(open2) {
    return bind3($lazy_parseTickExpr1(577))(function(value) {
      return bind3(tokTick)(function(close2) {
        return pure8({
          open: open2,
          value,
          close: close2
...
var $lazy_parseTickExpr1 = /* @__PURE__ */ $runtime_lazy5("parseTickExpr1", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseExpr3(583))(function(expr) {
      return bind3(many2(apply5(map15(Tuple.create)(parseQualifiedOperator))($lazy_parseExpr3(584))))(function(ops) {
        return pure8(function() {
          var v1 = fromArray(ops);
          if (v1 instanceof Nothing) {
            return expr;
...
var $lazy_parseWhere = /* @__PURE__ */ $runtime_lazy5("parseWhere", "PureScript.CST.Parser", function() {
  return defer4(function(v) {
    return bind3($lazy_parseExpr(800))(function(expr) {
      return bind3(optional3(apply5(map15(Tuple.create)(tokKeyword("where")))(layoutNonEmpty(recoverLetBinding($lazy_parseLetBinding(801))))))(function(bindings) {
        return pure8({
          expr,
          bindings
        });
...
var parseDeclValue = /* @__PURE__ */ bind3(parseIdent)(function(ident) {
  return alt4(parseDeclSignature(ident))(parseDeclValue1(ident));
});
var parseInstanceBindingName = function(name2) {
  return bind3(many2(parseBinderAtom))(function(binders) {
    return bind3(parseGuarded(tokEquals))(function(guarded) {
      return pure8(new InstanceBindingName({
        name: name2,
        binders,
        guarded
      }));
...
var parseInstanceBinding = /* @__PURE__ */ bind3(parseIdent)(function(ident) {
  return alt4(parseInstanceBindingSignature(ident))(parseInstanceBindingName(ident));
});
var parseInstance = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("instance"))(function(keyword) {
  return bind3(optional3(parseInstanceName))(function(name2) {
    return bind3(optional3($$try4(apply5(map15(Tuple.create)(parseClassConstraints(parseType3)))(tokRightFatArrow))))(function(constraints) {
      return bind3(parseQualifiedProper)(function(className) {
        return bind3(many2(parseTypeAtom))(function(types) {
          return bind3(optional3(apply5(map15(Tuple.create)(tokKeyword("where")))(layoutNonEmpty(parseInstanceBinding))))(function(body) {
            return pure8({
              head: {
                keyword,
                name: name2,
...
var parseDeclInstanceChain = /* @__PURE__ */ function() {
  return map15(DeclInstanceChain.create)(separated(parseInstanceChainSeparator)(parseInstance));
}();
var parseDeclClass1 = function(keyword) {
  return bind3(optional3($$try4(apply5(map15(Tuple.create)(parseClassConstraints(parseType5)))(tokLeftFatArrow))))(function($$super) {
    return bind3(parseProper)(function(name2) {
      return bind3(many2(parseTypeVarBinding))(function(vars) {
        return bind3(optional3(apply5(map15(Tuple.create)(tokPipe))(separated(tokComma)(parseFundep))))(function(fundeps) {
          return bind3(optional3(apply5(map15(Tuple.create)(tokKeyword("where")))(layoutNonEmpty(parseClassMember))))(function(members) {
            return pure8(new DeclClass({
              keyword,
              "super": $$super,
              name: name2,
              vars,
...
var parseDeclClass = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("class"))(function(keyword) {
  return alt4(parseDeclClassSignature(keyword))(parseDeclClass1(keyword));
});
var parseDeclData1 = function(keyword) {
  return function(name2) {
    return bind3(many2(parseTypeVarBinding))(function(vars) {
      return bind3(optional3(apply5(map15(Tuple.create)(tokEquals))(separated(tokPipe)(parseDataCtor))))(function(ctors) {
        return pure8(new DeclData({
          keyword,
          name: name2,
          vars
        }, ctors));
...
var parseDeclData = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("data"))(function(keyword) {
  return bind3(parseProper)(function(name2) {
    return alt4(parseDeclKindSignature(keyword)(name2))(parseDeclData1(keyword)(name2));
  });
});
var parseDeclNewtype1 = function(keyword) {
  return function(name2) {
    return bind3(many2(parseTypeVarBinding))(function(vars) {
      return bind3(tokEquals)(function(tok) {
        return bind3(parseProper)(function(wrapper) {
          return bind3(parseTypeAtom)(function(body) {
            return pure8(new DeclNewtype({
              keyword,
              name: name2,
              vars
            }, tok, wrapper, body));
...
var parseDeclNewtype = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("newtype"))(function(keyword) {
  return bind3(parseProper)(function(name2) {
    return alt4(parseDeclKindSignature(keyword)(name2))(parseDeclNewtype1(keyword)(name2));
  });
});
var parseDeclType2 = function(keyword) {
  return function(name2) {
    return bind3(many2(parseTypeVarBinding))(function(vars) {
      return bind3(tokEquals)(function(tok) {
        return bind3(parseType)(function(body) {
          return pure8(new DeclType({
            keyword,
            name: name2,
            vars
          }, tok, body));
...
var parseDeclType1 = function(keyword) {
  return bind3(parseProper)(function(name2) {
    return alt4(parseDeclKindSignature(keyword)(name2))(parseDeclType2(keyword)(name2));
  });
};
var parseDeclType = /* @__PURE__ */ bind3(/* @__PURE__ */ tokKeyword("type"))(function(keyword) {
  return alt4(parseDeclRole(keyword))(parseDeclType1(keyword));
});
var parseDecl = /* @__PURE__ */ alt4(parseDeclData)(/* @__PURE__ */ alt4(parseDeclNewtype)(/* @__PURE__ */ alt4(parseDeclType)(/* @__PURE__ */ alt4(parseDeclClass)(/* @__PURE__ */ alt4(parseDeclInstanceChain)(/* @__PURE__ */ alt4(parseDeclDerive)(/* @__PURE__ */ alt4(parseDeclValue)(/* @__PURE__ */ alt4(parseDeclForeign)(parseDeclFixity))))))));
var parseModuleDecls = /* @__PURE__ */ many2(/* @__PURE__ */ applyFirst3(/* @__PURE__ */ recoverDecl(parseDecl))(/* @__PURE__ */ alt4(tokLayoutSep)(/* @__PURE__ */ lookAhead(tokLayoutEnd))));
var parseModuleBody = /* @__PURE__ */ bind3(/* @__PURE__ */ applyFirst3(parseModuleDecls)(tokLayoutEnd))(function(decls) {
  return bind3(eof)(function(v) {
    return pure8({
      decls,
...
var parseModule = /* @__PURE__ */ bind3(parseModuleHeader)(function(header) {
  return bind3(parseModuleBody)(function(body) {
    return pure8({
      header,
      body
    });
...
var formatInPlaceCommand = function(shouldCheck) {
  return function(operators) {
    return function(v) {
      ...
      return bind4(readTextFile2(UTF8.value)(v.filePath))(function(contents) {
        return bind4(liftEffect3(hrtime))(function(start) {
          var v1 = formatCommand(formatOptions)(operators)(contents);
          if (v1 instanceof Right) {
            return bind4(map16(function($49) {
...
var main = /* @__PURE__ */ makeAsMain()(function(v) {
  var parsedOperatorsByPath = map17(function(operators) {
    return defer2(function(v1) {
      return parseOperatorTable(operators);
    });
  ...
  return v.receive(function(v1) {
    ...
    return runAff_(either(throwError3)(v.reply))(formatInPlaceCommand(v.workerData.shouldCheck)(operators)(v1));
  });
});
